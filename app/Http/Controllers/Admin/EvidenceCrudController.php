...
class EvidenceCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('effect_id')->type('number')->label('enter the Effect ID to link this piece of evidence to an effect');
        CRUD::field('description');
        CRUD::field('files')->type('upload_multiple');
        CRUD::field('files_description');
        CRUD::field('urls');
    }
